...
- **Wrapper install:** `npm run release` writes a shell wrapper to `~/.local/bin/crsr`; self-update refuses to overwrite that wrapper and tells you to rebuild from source instead.
